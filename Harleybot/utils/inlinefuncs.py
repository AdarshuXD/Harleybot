...
from Harleybot import pbot as app 
from Harleybot import arq
from Harleybot.services.keyboard import Ikb
from Harleybot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Harleybot.services.tasks import _get_tasks_text, all_tasks, rm_task
from Harleybot.services.types import InlineQueryResultCachedDocument
from Harleybot.modules.info import get_chat_info, get_user_info
from Harleybot.modules.music import download_youtube_audio
from Harleybot.utils.functions import test_speedtest
from Harleybot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/MissHarleybot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[MissHarleybot ❤️](https://t.me/OfficialAD):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Bio_AD)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://te.legra.ph/file/55462ead00cde71459625.jpg",
            input_message_content=InputTextMessageContent(
