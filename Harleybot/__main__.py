...
from Harleybot.modules import ALL_MODULES
from Harleybot.modules.helper_funcs.chat_status import is_user_admin
from Harleybot.modules.helper_funcs.misc import paginate_modules
...
yumi_IMG = "https://te.legra.ph/file/fb852c168f7dfb653f59e.jpg"
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="Aʙᴏᴜᴛ", callback_data="Harleybot_"),
        InlineKeyboardButton(
            text="Bᴀꜱɪᴄ Hᴇʟᴘ", callback_data="Harleybot_basichelp"
        ),
    ],
    [
