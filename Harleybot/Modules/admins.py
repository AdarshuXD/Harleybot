...
from Harleybot import DRAGONS, dispatcher
from Harleybot.modules.disable import DisableAbleCommandHandler
from Harleybot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_pin,
    can_promote,
    connection_status,
...
from Harleybot.modules.helper_funcs.admin_rights import user_can_changeinfo, user_can_promote
from Harleybot.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from Harleybot.modules.log_channel import loggable
from Harleybot.modules.helper_funcs.alternate import send_message
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("Bhai,Bhen jo bhi ho apke pass ye right na ha sorry aur so sameless you are saste admin  🙂 dil se bura laga support @Anmol_Dost")
        return
...
def lowpromote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("Bhai,Bhen jo bhi ho apke pass ye right na ha sorry 🙂 dil se bura laga support @Anmol_Dost ")
        return
