...
import html
import requests
import Harleybot.modules.sql.chatbot_sql as sql
...
from Harleybot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Harleybot import dispatcher, updater, SUPPORT_CHAT
from Harleybot.modules.log_channel import gloggable
...
__help__ = """
✗ `Chatbot utilizes the` *Harley* `api which allows Lyra to talk and provide a more interactive group chat experience.`
